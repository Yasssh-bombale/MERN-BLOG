...
const SignUp = () => {
  return (
    <div className="border border-black min-h-screen mt-20">
      <div className="border border-black flex flex-col md:flex-row md:items-center max-w-3xl mx-auto gap-5">
        {/* left side */}
        {/* flex-1 cause equal distribution of size between left part and right part */}
        <div className="flex-1 flex flex-col ">
          <Link
            to={"/"}
            className=" text-2xl md:text-4xl  font-bold dark:text-white self-center md:self-start"
          >
